...
const faqs = [
  {
    ...
    answer:
      "المنشأة الابتكارية (Innovative SME) هي منشأة صغيرة أو متوسطة استفادت مالياً من تبني تقنية صاعدة أو ابتكار، سواءً تم تطبيق ذلك في منتجات وخدمات المنشأة، أم نموذج عملها التجاري، أم في بيئة عملها وعملياتها الداخلية.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "التقنيات الصاعدة (Emerging Technologies) هي التقنيات الحديثة الواعدة التي لا تزال استخداماتها وفوائدها التجارية والاجتماعية تظهر يوماً بعد يوم، مثل تقنية الذكاء الاصطناعي وتقنية الحوسبة السحابية وتقنية النمذجة السريعة والتقنية الحيوية وغيرها.",
  },
];
